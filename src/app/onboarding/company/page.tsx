...
export default function CompanyVerification() {
  ...
  const initializeVerification = async () => {
    try {
      ...
      console.log('[DEBUG] Iniciando verificação de pessoa jurídica...');
      
      // Gerar userId baseado no CNPJ
      const newUserId = generateUserIdFromCNPJ(cnpj);
          ...
          {!showSDK ? (
            ...
            <div className="max-w-md mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Digite o CNPJ para iniciar o processo de verificação empresarial
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  />
                  {cnpjError && (
                    <p className="mt-2 text-sm text-red-600">{cnpjError}</p>
                  )}
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      Utilizamos o CNPJ apenas para identificação única no sistema. 
