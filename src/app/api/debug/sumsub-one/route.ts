...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`[DEBUG-ONE] Buscando dados com /one para applicantId: ${applicantId}`);

    // Chamar API do Sumsub COM /one
    ...
    console.log(`[DEBUG-ONE] Dados recebidos - type: ${data.type}, hasInfo: ${!!data.info}, hasRequiredIdDocs: ${!!data.requiredIdDocs}`);
    ...
    console.error('[DEBUG-ONE] Erro:', error);
    return NextResponse.json(
